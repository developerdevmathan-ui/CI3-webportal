...
<main class="container py-5">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <h1 class="h2 mb-1">Receipt Details</h1>
            <p class="text-muted mb-0">Review the receipt generated for your successful payment.</p>
        </div>
        <a class="btn btn-outline-secondary" href="<?php echo site_url('user/receipts'); ?>">Back</a>
    </div>
